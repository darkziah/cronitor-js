...
class Monitor {
    ...
    async ok(params) {
        return this.ping(Object.assign(Object.assign({}, params), { state: Monitor.State.OK }));
    }
    async delete() {
        try {
    ...
    async ping(params = {}) {
        ...
        try {
            await this._api.axios.get(this._api.pingUrl(this.key), {
                params,
                paramsSerializer: (params) => {
                    return qs_1.default.stringify(this._cleanParams(params), { arrayFormat: 'repeat', encode: false });
                }
            });
            return true;
        }
